...
HD_PWD='/home/alhua/VivadoProject/RMSnorm/RMSnorm.runs/c_shift_ram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_shift_ram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_shift_ram_1.tcl
