...
HD_PWD='/home/alhua/VivadoProject/RMSnorm/RMSnorm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RMSnorm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RMSnorm_wrapper.tcl
