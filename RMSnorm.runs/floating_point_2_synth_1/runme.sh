...
HD_PWD='/home/alhua/VivadoProject/RMSnorm/RMSnorm.runs/floating_point_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_2.tcl
