...
synth_design -top c_shift_ram_0 -part xck26-sfvc784-2LV-c -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp c_shift_ram_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips c_shift_ram_0]
 }
...
generate_parallel_reports -reports { "report_utilization -file c_shift_ram_0_utilization_synth.rpt -pb c_shift_ram_0_utilization_synth.pb"  } 
