...
HD_PWD='/home/alhua/VivadoProject/RMSnorm/RMSnorm.runs/bf_sub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bf_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bf_sub.tcl
