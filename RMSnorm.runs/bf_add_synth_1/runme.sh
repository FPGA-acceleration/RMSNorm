...
HD_PWD='/home/alhua/VivadoProject/RMSnorm/RMSnorm.runs/bf_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bf_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bf_add.tcl
