...
#
# Script generated by Vivado on Wed Oct 29 12:28:27 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RMSnormv2.sh
...
#
# Usage        : RMSnormv2.sh
#                RMSnormv2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RMSnormv2.sh [-reset_run]
#                RMSnormv2.sh [-reset_log]
#                RMSnormv2.sh [-help]
#
...
# script info
echo -e "RMSnormv2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RMSnormv2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RMSnormv2 xil_defaultlib.RMSnormv2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RMSnormv2 -key {Behavioral:sim_1:Functional:RMSnormv2} -tclbatch cmd.tcl -protoinst "protoinst_files/RMSnorm.protoinst" -protoinst "protoinst_files/RMSnormv2.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RMSnormv2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RMSnormv2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RMSnormv2.sh [-help]\n\
Usage: RMSnormv2.sh [-step]\n\
Usage: RMSnormv2.sh [-lib_map_path]\n\
Usage: RMSnormv2.sh [-reset_run]\n\
Usage: RMSnormv2.sh [-reset_log]\n\
Usage: RMSnormv2.sh [-keep_index]\n\
Usage: RMSnormv2.sh [-noclean_files]\n\n\
