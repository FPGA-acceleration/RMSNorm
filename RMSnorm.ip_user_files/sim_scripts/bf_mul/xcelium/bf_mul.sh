...
#
# Script generated by Vivado on Tue Oct 28 19:42:15 CST 2025
...
#
# Usage        : bf_mul.sh
#                bf_mul.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bf_mul.sh [-reset_run]
#                bf_mul.sh [-reset_log]
#                bf_mul.sh [-help]
#
...
#                script (type 'bf_mul.sh -help' for more information).
#
...
# script info
echo -e "bf_mul.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bf_mul.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bf_mul xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bf_mul -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bf_mul_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bf_mul.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bf_mul.sh [-help]\n\
Usage: bf_mul.sh [-step]\n\
Usage: bf_mul.sh [-lib_map_path]\n\
Usage: bf_mul.sh [-reset_run]\n\
Usage: bf_mul.sh [-reset_log]\n\
Usage: bf_mul.sh [-keep_index]\n\
Usage: bf_mul.sh [-noclean_files]\n\n\
