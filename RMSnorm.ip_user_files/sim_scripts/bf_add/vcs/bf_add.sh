...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bf_add xil_defaultlib.glbl -o bf_add_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bf_add_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bf_add_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bf_add_simv.daidir vcs_lib c.obj)
