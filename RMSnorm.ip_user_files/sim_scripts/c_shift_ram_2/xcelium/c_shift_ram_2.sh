...
#
# Script generated by Vivado on Tue Oct 28 19:42:11 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : c_shift_ram_2.sh
...
#
# Usage        : c_shift_ram_2.sh
#                c_shift_ram_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                c_shift_ram_2.sh [-reset_run]
#                c_shift_ram_2.sh [-reset_log]
#                c_shift_ram_2.sh [-help]
#
...
#                script (type 'c_shift_ram_2.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_14 -libname c_reg_fd_v12_0_10 -libname c_shift_ram_v12_0_18 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_14 c_reg_fd_v12_0_10 c_shift_ram_v12_0_18 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "c_shift_ram_2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./c_shift_ram_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.c_shift_ram_2
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.c_shift_ram_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log c_shift_ram_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./c_shift_ram_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: c_shift_ram_2.sh [-help]\n\
Usage: c_shift_ram_2.sh [-step]\n\
Usage: c_shift_ram_2.sh [-lib_map_path]\n\
Usage: c_shift_ram_2.sh [-reset_run]\n\
Usage: c_shift_ram_2.sh [-reset_log]\n\
Usage: c_shift_ram_2.sh [-keep_index]\n\
Usage: c_shift_ram_2.sh [-noclean_files]\n\n\
