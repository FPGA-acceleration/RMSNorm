...
design_libs=(xbip_utils_v3_0_14 c_reg_fd_v12_0_10 c_shift_ram_v12_0_18 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.c_shift_ram_2 -o c_shift_ram_2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./c_shift_ram_2_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alhua/VivadoProject/RMSnorm/RMSnorm.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key c_shift_ram_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc c_shift_ram_2_simv.daidir vcs_lib c.obj)
