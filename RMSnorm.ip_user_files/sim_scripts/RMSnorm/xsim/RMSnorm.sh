...
#
# Script generated by Vivado on Mon Oct 27 22:15:18 CST 2025
...
#
# Usage        : RMSnorm.sh
#                RMSnorm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RMSnorm.sh [-reset_run]
#                RMSnorm.sh [-reset_log]
#                RMSnorm.sh [-help]
#
...
# script info
echo -e "RMSnorm.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RMSnorm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RMSnorm xil_defaultlib.RMSnorm xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RMSnorm -key {Behavioral:sim_1:Functional:RMSnorm} -tclbatch cmd.tcl -protoinst "protoinst_files/RMSnorm.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RMSnorm.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RMSnorm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RMSnorm.sh [-help]\n\
Usage: RMSnorm.sh [-step]\n\
Usage: RMSnorm.sh [-lib_map_path]\n\
Usage: RMSnorm.sh [-reset_run]\n\
Usage: RMSnorm.sh [-reset_log]\n\
Usage: RMSnorm.sh [-keep_index]\n\
Usage: RMSnorm.sh [-noclean_files]\n\n\
