...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_1 xil_defaultlib.glbl -o floating_point_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating_point_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating_point_1_simv.daidir vcs_lib c.obj)
