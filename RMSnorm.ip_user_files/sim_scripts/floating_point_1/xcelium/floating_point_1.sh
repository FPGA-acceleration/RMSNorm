...
#
# Script generated by Vivado on Tue Oct 28 19:42:13 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : floating_point_1.sh
...
#
# Usage        : floating_point_1.sh
#                floating_point_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_1.sh [-reset_run]
#                floating_point_1.sh [-reset_log]
#                floating_point_1.sh [-help]
#
...
#                script (type 'floating_point_1.sh -help' for more information).
#
...
# script info
echo -e "floating_point_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.floating_point_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.floating_point_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log floating_point_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./floating_point_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: floating_point_1.sh [-help]\n\
Usage: floating_point_1.sh [-step]\n\
Usage: floating_point_1.sh [-lib_map_path]\n\
Usage: floating_point_1.sh [-reset_run]\n\
Usage: floating_point_1.sh [-reset_log]\n\
Usage: floating_point_1.sh [-keep_index]\n\
Usage: floating_point_1.sh [-noclean_files]\n\n\
