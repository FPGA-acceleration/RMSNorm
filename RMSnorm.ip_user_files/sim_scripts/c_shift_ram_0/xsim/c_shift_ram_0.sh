...
#
# Script generated by Vivado on Thu Oct 30 22:41:02 CST 2025
...
#
# Usage        : c_shift_ram_0.sh
#                c_shift_ram_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                c_shift_ram_0.sh [-reset_run]
#                c_shift_ram_0.sh [-reset_log]
#                c_shift_ram_0.sh [-help]
#
...
export RDI_DATADIR="/home/anderson/vivado/Vivado/2024.2/data"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "c_shift_ram_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./c_shift_ram_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L c_shift_ram_v12_0_18 -L secureip -L xpm --snapshot c_shift_ram_0 xil_defaultlib.c_shift_ram_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim c_shift_ram_0 -key {Behavioral:sim_1:Functional:c_shift_ram_0} -tclbatch cmd.tcl -protoinst "protoinst_files/RMSnorm.protoinst" -protoinst "protoinst_files/RMSnormv2.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/anderson/vivado/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb c_shift_ram_0.wdb xsim.dir libdpi.so)
...
Usage: c_shift_ram_0.sh [-step]\n\
Usage: c_shift_ram_0.sh [-lib_map_path]\n\
Usage: c_shift_ram_0.sh [-reset_run]\n\
Usage: c_shift_ram_0.sh [-reset_log]\n\
Usage: c_shift_ram_0.sh [-keep_index]\n\
