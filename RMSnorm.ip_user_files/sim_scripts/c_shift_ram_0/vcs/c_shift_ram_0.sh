...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/anderson/vivado/project/RMSNorm/RMSnorm.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key c_shift_ram_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc c_shift_ram_0_simv.daidir vcs_lib c.obj)
