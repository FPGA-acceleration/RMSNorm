...
#
# Script generated by Vivado on Tue Oct 28 21:49:21 CST 2025
...
#
# Usage        : c_shift_ram_1.sh
#                c_shift_ram_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                c_shift_ram_1.sh [-reset_run]
#                c_shift_ram_1.sh [-reset_log]
#                c_shift_ram_1.sh [-help]
#
...
#                script (type 'c_shift_ram_1.sh -help' for more information).
#
...
# script info
echo -e "c_shift_ram_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./c_shift_ram_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.c_shift_ram_1
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.c_shift_ram_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log c_shift_ram_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: c_shift_ram_1.sh [-step]\n\
Usage: c_shift_ram_1.sh [-lib_map_path]\n\
Usage: c_shift_ram_1.sh [-reset_run]\n\
Usage: c_shift_ram_1.sh [-reset_log]\n\
Usage: c_shift_ram_1.sh [-keep_index]\n\
