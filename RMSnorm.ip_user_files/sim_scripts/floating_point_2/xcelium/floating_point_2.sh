...
#
# Script generated by Vivado on Mon Oct 27 21:22:16 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : floating_point_2.sh
...
#
# Usage        : floating_point_2.sh
#                floating_point_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_2.sh [-reset_run]
#                floating_point_2.sh [-reset_log]
#                floating_point_2.sh [-help]
#
...
#                script (type 'floating_point_2.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_14 -libname axi_utils_v2_0_10 -libname xbip_pipe_v3_0_10 -libname xbip_dsp48_wrapper_v3_0_6 -libname mult_gen_v12_0_22 -libname floating_point_v7_1_19 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_14 axi_utils_v2_0_10 xbip_pipe_v3_0_10 xbip_dsp48_wrapper_v3_0_6 mult_gen_v12_0_22 floating_point_v7_1_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "floating_point_2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work floating_point_v7_1_19 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.floating_point_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.floating_point_2 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alhua/VivadoProject/RMSnorm/RMSnorm.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log floating_point_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./floating_point_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: floating_point_2.sh [-help]\n\
Usage: floating_point_2.sh [-step]\n\
Usage: floating_point_2.sh [-lib_map_path]\n\
Usage: floating_point_2.sh [-reset_run]\n\
Usage: floating_point_2.sh [-reset_log]\n\
Usage: floating_point_2.sh [-keep_index]\n\
Usage: floating_point_2.sh [-noclean_files]\n\n\
