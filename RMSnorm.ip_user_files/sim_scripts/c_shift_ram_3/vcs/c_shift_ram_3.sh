...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.c_shift_ram_3 -o c_shift_ram_3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./c_shift_ram_3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key c_shift_ram_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc c_shift_ram_3_simv.daidir vcs_lib c.obj)
