...
export RDI_DATADIR="/home/alhua/vivado/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L c_shift_ram_v12_0_18 -L secureip -L xpm --snapshot c_shift_ram_3 xil_defaultlib.c_shift_ram_3 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim c_shift_ram_3 -key {Behavioral:sim_1:Functional:c_shift_ram_3} -tclbatch cmd.tcl -protoinst "protoinst_files/RMSnorm.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alhua/vivado/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb c_shift_ram_3.wdb xsim.dir libdpi.so)
